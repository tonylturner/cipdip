...
- `notes/ODVA_COMPLIANCE_REALITY.md` - keep; update assumptions after strict-mode changes.
...
- `notes/SUMMARY.md` -> merge key bits into `README.md`, then retire.
- `notes/PROJECT_SUMMARY.md` -> retire (overlaps with README + STATUS).
- `notes/NEXT_STEPS.md` -> retire (replaced by `tasks.md`).
- `notes/AUDIT_SUMMARY.md` -> retire (historic; summary now in `tasks.md`).
- `notes/AUDIT_RECOMMENDATIONS.md` -> retire or archive (superseded by DPI/ODVA roadmap).

### Keep (templates, mark pending)
- `notes/VENDOR_RESEARCH.md` - keep; mark “pending captures”.
- `docs/vendors/README.md` - keep; link from `notes/VENDOR_RESEARCH.md`.
