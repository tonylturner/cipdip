...
func LabelService(service uint8, path protocol.CIPPath, isResponse bool) (string, bool) {
	...
	case 0x52:
		if path.Class == connectionManagerClass && path.Instance == connectionManagerInst {
			...
			switch path.Class {
			case symbolObjectClass, templateObjectClass:
